...
private static final Logger logger = LoggerFactory.getLogger(UserServiceImpl.class);
	...
	public Meetup approveDenyMeetup(Meetup m)
	{
		...
		System.out.println("Before update, meetup status: "+meetupDao.getById(m.getMeetupID()).getMeetupStatus());
		if (m.getMeetupStatus().equals("Approved") || m.getMeetupStatus().equals("Denied"))
		{
			...
			System.out.println("Before update, meetup status: "+ meetupDao.getById(meetup.getMeetupID()).getMeetupStatus());
		}
