...
const routes: Routes = [
  ...
  { path: 'visits/:sDate', component: ManageVisitorFormsComponent },
  { path: 'animalList', component: ManagelistOfAnimalsComponent },
  { path: 'animalProfile/:animalID', component : AnimalProfileComponent},
  { path: 'adoptionForm/:animalID/:animalName', component: AdoptionFormComponent},
  { path: 'visitorForm/:animalID/:animalName', component : VisitorFormComponent},
